...
public class ModernTypesEvent
{
	...
	public Half SmallNumber
	{
		get; set;
	}
	public Int128 LargeNumber
	{
		get; set;
	}
}
...
{
	// KeyValuePair<K,V>
	public KeyValuePair<CustomKey, CustomValue> SinglePair
	{
		get; set;
	}
	...
	public ValueTuple<CustomKey, CustomValue> ValueTupleOfCustomTypes
	{
		get; set;
	}
