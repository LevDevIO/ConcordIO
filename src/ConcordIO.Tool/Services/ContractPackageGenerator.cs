...
public abstract class PackageOptionsBase
{
	...
	public required string Authors
	{
		get; init;
	}
	...
	public required Dictionary<string, List<string>> SpecsByKind
	{
		get; init;
	}
}
...
public class ClientPackageOptions : PackageOptionsBase
{
	...
	/// </summary>
	public required string ClientPackageId
	{
		get; init;
	}
	...
	/// </summary>
	public required string ContractPackageId
	{
		get; init;
	}
	...
	/// </summary>
	public required string ContractVersion
	{
		get; init;
	}
	...
	/// </summary>
	public required string NSwagClientClassName
	{
		get; init;
	}
	...
	/// </summary>
	public required string NSwagOutputPath
	{
		get; init;
	}
...
{
	public required string NuspecPath
	{
		get; init;
	}
	public required string NuspecContent
	{
		get; init;
	}
	public required string TargetsPath
	{
		get; init;
	}
	public required string TargetsContent
	{
		get; init;
	}
}
